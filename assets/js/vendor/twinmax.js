      ...
      if (!v) {
       ...
       ;(v.max = r - s),
        ...
        (v.v = u =
         b.amount ||
         b.each *
          (t > u ? u : h ? ('y' === h ? u / t : t) : Math.max(t, u / t)) ||
         0),
        (v.b = 0 > u ? e - u : e)
      }
   ...
   ;(g.version = '2.1.2'),
     ...
     for (
      p._lazy !== !1 && (p._lazy = !1),
       ...
       0 === s &&
        ...
        p._startAt &&
         (a >= 0 ? p._startAt.render(a, !0, d) : f || (f = '_dummyGS')),
        p.vars.onStart &&
         (0 !== p._totalTime || 0 === u) &&
    ...
    (g.staggerTo = g.allTo =
     function (a, b, h, i, l, n, o) {
      ...
      for (
       k(a) ||
        ('string' == typeof a && (a = c.selector(a) || a), j(a) && (a = d(a))),
        a = a || [],
        p = a.length - 1,
        r = 0;
       p >= r;
     ...
     (s.add = function (e, f, g, h) {
      ...
      if (
       ...
       (e._time || (!e._duration && e._initted)) &&
        ...
        (!e._duration ||
         Math.abs(Math.max(0, Math.min(e.totalDuration(), j))) - e._totalTime >
          1e-5) &&
         e.render(j, !1, !1)),
   ...
   function (a, b) {
    ...
    var ya = function (a, b) {
      ;(b = b || {}),
       ...
       (i[a] = i[this.p] = this),
       (this.format =
        b.formatter || ra(b.defaultValue, b.color, b.collapsible, b.multi)),
    ...
    var Ba,
     ...
     Ra = function (a, b) {
      ...
      if (
       ...
       Da &&
        ...
        g &&
         (h ? i.insertBefore(a, h) : i ? i.appendChild(a) : Ka.removeChild(a))),
       (j.svg || (a.getCTM && Pa(a))) &&
     ...
     Sa = (S.getTransform = function (a, c, d, e) {
      ...
      var f,
       ...
       p = 1e5,
       q = Ga
        ? parseFloat(aa(a, Fa, c, !1, '0 0 0').split(' ')[2]) || m.zOrigin || 0
        : 0,
          ...
          (A =
           c !== d[z]
            ...
            : 2 > xa
              ...
              : o - d.ieOffsetY),
          (l[z] =
           (d[z] = Math.round(c - A * (0 === xa || 2 === xa ? 1 : B))) + 'px')
       }
      }
     },
     Ua =
    ...
    ;(j = Ha.prototype),
     ...
     za('border', {
      ...
      formatter: function (a) {
       var b = a.split(' ')
       return (
        b[0] + ' ' + (b[1] || 'solid') + ' ' + (a.match(qa) || ['#000'])[0]
       )
      },
     }),
     za('borderWidth', {
