         ...
         : u.onAPIready(function () {
            ...
            u.$video ||
             ...
             'youtube' === u.type &&
                ...
                u.options.mute
                 ...
                 setInterval(function () {
                  u.getVolume(function (e) {
                   u.options.volume !== e &&
                    ((u.options.volume = e), u.fire('volumechange', t))
                  })
                 }, 150)
               },
              ...
              (u.player =
               u.player || new s.a.YT.Player(u.playerID, u.playerOptions)),
              i &&
               ((u.$video = document.getElementById(u.playerID)),
               (u.videoWidth =
                parseInt(u.$video.getAttribute('width'), 10) || 1280),
               (u.videoHeight =
                parseInt(u.$video.getAttribute('height'), 10) || 720))),
             'vimeo' === u.type &&
              ((u.playerOptions = {
               dnt: 1,
               id: u.videoID,
              ...
              u.$video ||
               ...
               Object.keys(u.playerOptions).forEach(function (e) {
                '' !== a && (a += '&'),
                 (a += ''
                  .concat(e, '=')
                  .concat(encodeURIComponent(u.playerOptions[e])))
               }),
               ...
               document.body.appendChild(e)),
              (u.player =
               u.player || new s.a.Vimeo.Player(u.$video, u.playerOptions)),
              u.options.startTime &&
               u.options.autoplay &&
