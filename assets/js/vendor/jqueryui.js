...
;(function (e) {
   ...
   ;(e.position = {
    ...
    getScrollInfo: function (t) {
     var i = t.isWindow || t.isDocument ? '' : t.element.css('overflow-x'),
      ...
      n =
       'scroll' === i || ('auto' === i && t.width < t.element[0].scrollWidth),
      a =
       'scroll' === s || ('auto' === s && t.height < t.element[0].scrollHeight)
     return {
        ...
        n.using &&
         (l = function (e) {
          ...
          d > m && m > r(t + i) && (h.horizontal = 'center'),
           ...
           (h.important =
            o(r(t), r(i)) > o(r(s), r(a)) ? 'horizontal' : 'vertical'),
  ...
  e.widget('ui.menu', {
   ...
   _move: function (e, t, i) {
    ...
    this.active &&
     (s =
      'first' === e || 'last' === e
       ? this.active['first' === e ? 'prevAll' : 'nextAll']('.ui-menu-item').eq(
          -1
         )
 ...
 e.extend(n.prototype, {
  ...
  _setDateDatepicker: function (e, t) {
   ...
   i &&
    (this._setDate(i, t), this._updateDatepicker(i), this._updateAlternate(i))
  },
  _getDateDatepicker: function (e, t) {
   var i = this._getInst(e)
   return (
    i && !i.inline && this._setDateFromField(i, t), i ? this._getDate(i) : null
   )
  },
  ...
  _checkOffset: function (t, i, s) {
   var n = t.dpDiv.outerWidth(),
    ...
    h =
     document.documentElement.clientWidth + (s ? 0 : e(document).scrollLeft()),
    l =
     document.documentElement.clientHeight + (s ? 0 : e(document).scrollTop())
   return (
  ...
  _adjustInstDate: function (e, t, i) {
   var s = e.drawYear + ('Y' === i ? t : 0),
    ...
    a =
     Math.min(e.selectedDay, this._getDaysInMonth(s, n)) + ('D' === i ? t : 0),
  ...
  e.widget('ui.dialog', {
   ...
   _size: function () {
    ...
    this.element.show().css({
     ...
     (i =
      'number' == typeof s.maxHeight ? Math.max(0, s.maxHeight - e) : 'none'),
     'auto' === s.height
      ? this.element.css({
         minHeight: t,
         maxHeight: i,
    ...
    (e.effects.animateClass = function (n, a, o, r) {
     ...
     return this.queue(function () {
      ...
      ;(l = l.map(function () {
       ...
       (l = l.map(function () {
        return (
         (this.end = t(this.el[0])), (this.diff = i(this.start, this.end)), this
        )
       })),
       o.attr('class', r),
       (l = l.map(function () {
  ...
  (e.effects.effect.bounce = function (t, i) {
   ...
   for (
    ...
    (n = {}),
     ...
     (c = l ? 2 * c : c / 2)
   l &&
    ((n = { opacity: 0 }), (n[v] = (y ? '-=' : '+=') + c), o.animate(n, m, g)),
    o.queue(function () {
     ...
     this.options.disabled ||
      ...
      e(t.target)
       ...
       .each(function () {
        ...
        return n
         ? ((s =
            (!t.metaKey && !t.ctrlKey) || !n.$element.hasClass('ui-selected')),
           n.$element
