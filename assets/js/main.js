...
//  document.getElementById('copyrightYear').textContent = year
 ...
 // hide media from tabs
 document.querySelectorAll('a[href="#"]').forEach(function (link) {
  if (link.textContent.trim() === 'MEDIA') {
   link.parentElement.style.display = 'none'
  }
 })

 window.onload = function () {
  document.getElementById('event-count-down-modal').style.display = 'flex'
 }


window.closeModal = function () {
  document.getElementById('event-count-down-modal').style.display = 'none';
}
 ...
 var drJs = {
  ...
  //   $('.video-overlay-home').addClass('open')
  //   $('.video-overlay').append(
  //    '<iframe width="560" height="315" src="https://www.youtube.com/embed/RfxXF4Tpu74" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
  //   )
  //   $('.video-overlay-home').append(
  //    '<iframe width="560" height="315" src="https://www.youtube.com/embed/YRPC3hAjOdQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
  //   )
  //  })
  ...
  //  $('.video-overlay, .video-overlay-home-close').on('click', function (e) {
  //   e.preventDefault()
  //   close_video()
  //  })
  ...
  //  }
  //  function close_video() {
  //   $('.video-overlay-home.open').removeClass('open').find('iframe').remove()
  //  }
  // },
  vedioActivation: function () {
   // Reusable video for multiple parts of the website
   const defaultVideoSrc = 'https://www.youtube.com/embed/RfxXF4Tpu74'
   const bannerSpecificVideoSrc = 'https://www.youtube.com/embed/YRPC3hAjOdQ'

   // Event for reusable video
   $('#play-video, .play-video').on('click', function (e) {
    e.preventDefault()

    const target = $(this).closest('.vedio-icone') // Scope to the clicked context

    // Check if this is the banner-specific video
    if (target.parents('.swiper-slide').length > 0) {
     openVideoOverlay(bannerSpecificVideoSrc)
    } else {
     openVideoOverlay(defaultVideoSrc)
    }
   })

   // Event to close the video
   $('.video-overlay, .video-overlay-close, .video-overlay-home-close').on(
    'click',
    function (e) {
     e.preventDefault()
     closeVideoOverlay()
