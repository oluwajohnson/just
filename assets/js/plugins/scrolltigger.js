...
!(function (e, t) {
 ...
 function F(r, n) {
  function Qc(e) {
   if (e || 0 === e) {
    ...
    (n || k.cache !== Qc.cacheID || i('ref')) &&
     ((Qc.cacheID = k.cache), (Qc.v = r()))
 ...
 var C =
  ((Observer.prototype.init = function init(e) {
   ...
   var ee,
    ...
    pe = fe(),
    ge =
     ~t.indexOf('touch') && !~t.indexOf('pointer') && 'pointerdown' === ze[0],
    he = z(n),
 ...
 function ub(e, t, r, n, o, i, a, s) {
  ...
  return (
   ...
   a &&
    (x +=
     'box-sizing:border-box;text-align:left;width:' + a.offsetWidth + 'px;'),
   (p._isStart = b),
 ...
 function _b(e, t, r, n, o, i, a, s, l, c, u, f, d) {
  ...
  if (i) {
   ...
   ;(p = 'scroll' + n.d2),
    ...
    u &&
     ((l = Mt(a)), u && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + Et))
  }
  return (
   d &&
    h &&
   ...
   ((ScrollTrigger.prototype.init = function init(S, T) {
    if (
     ...
     var k,
      ...
      ge =
       S.horizontal || (S.containerAnimation && !1 !== S.horizontal) ? He : Je,
      he = !re && 0 !== re,
      ve = I(S.scroller || je),
      ...
      me =
       'fixed' ===
       ('pinType' in S ? S.pinType : y(ve, 'pinType') || (be && 'fixed')),
     ...
     if (
      ...
      a && (It[a] = _e),
      (i =
       (i = (ne = _e.trigger = I(ne || oe)) && ne._gsap && ne._gsap.stRevert) &&
       i(_e)),
      (oe = !0 === oe ? ne : I(oe)),
     ...
     ;(_e.previous = function () {
      ...
      (_e.labelToScroll = function (e) {
       return (
        (T &&
         T.labels &&
         (M || _e.refresh() || M) + (T.labels[e] / T.duration()) * z) ||
        0
       )
      }),
 ...
 function hc(e) {
  ...
  if (!a._isScrollT || 2e3 < s - a._isScrollT) {
   ...
   ;(a._isScroll =
    i && !Da(i) && i !== n && (oe[(t = db(i)).overflowY] || oe[t.overflowX])),
    (a._isScrollT = s)
  }
